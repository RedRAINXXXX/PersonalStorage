...
<div id="main-div" class="container">
    <div class="row">
        ...
        <div id="content-div" class="col-9 px-2 py-2">
            <form id="profile-form" action="${pageContext.request.contextPath}/investor/update-profile" method="post"
                  onsubmit="return fieldValidate(this, '修改公司信息成功')" novalidate>
                <div class="row mb-3">
                    <div class="col">
                ...
                <div class="row mb-3 justify-content-center">
                    ...
                    <div class="col-3">
                        <a class="btn btn-secondary w-100"
                           href="${pageContext.request.contextPath}/index">取消</a>
                    </div>
                </div>
            </form>
        </div>
