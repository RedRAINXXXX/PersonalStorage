...
<div id="main-div" class="container">
    <div class="row">
        ...
        <div id="content-div" class="col-9 px-2 py-2">
            <h1 class="text-center">投资方信息管理</h1>
            <div class="row mb-3">
                <div class="col-3">
                    <a href="${pageContext.request.contextPath}/admin/investor/insert-page" class="btn btn-primary w-100">新增</a>
                </div>
            </div>
            <table class="table">
                ...
                <c:forEach items="${investorList}" var="investor">
                    <tr>
                        ...
                        <td>${investor.legalRepresentative}</td>
                        <td>
                            <a href="${pageContext.request.contextPath}/admin/investor/detail/${investor.id}"
                               class="btn btn-primary mx-1">修改</a>
                            <a href="${pageContext.request.contextPath}/admin/investor/delete/${investor.id}"
